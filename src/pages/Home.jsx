    ...
    <div className="overflow-x-hidden">
      ...
      <section className="h-screen flex flex-col justify-center items-center text-center px-4 relative bg-gradient-to-br from-[#0f0f0f] to-[#1c1c1c] text-white">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-gray-300 text-lg sm:text-xl leading-relaxed mb-6">
            ...
            <span className="text-white font-semibold">GCNs</span>, and full-stack magic.
            <br />
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <Link
              to="/ai"
              className="bg-white text-black px-6 py-3 rounded-full font-semibold text-sm
                transition hover:scale-105 hover:shadow-[0_6px_0_rgba(0,0,0,0.2)] hover:translate-y-[-2px]"
            >
              🔍 AI Showcase
            </Link>
            <ScrollLink
              ...
              duration={500}
              offset={-70}
              className="bg-transparent border border-white px-6 py-3 rounded-full font-semibold text-sm
                text-white transition hover:bg-white hover:text-black hover:scale-105
                hover:shadow-[0_6px_0_rgba(255,255,255,0.2)] hover:translate-y-[-2px] cursor-pointer"
            >
              📂 Projects
            </ScrollLink>
          </div>
      ...
      <section id="projects" className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          {projects.length === 0 ? (
            <p className="text-center text-gray-400 text-sm">Loading projects…</p>
          ) : (
              ...
              {projects.slice(0, 2).map((project, index) => (
                <motion.div
                  ...
                  className="bg-white rounded-lg p-6 shadow-md border border-gray-200
                    hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer text-black"
                >
          ...
          >
            <Link
              to="/projects"
              className="group inline-flex items-center gap-2 bg-black text-white px-8 py-3 rounded-full
                font-semibold text-sm border border-black transition-all duration-300
                hover:bg-white hover:text-black hover:border-gray-400
                hover:shadow-[0_8px_24px_rgba(0,0,0,0.12)] hover:scale-105 hover:translate-y-[-2px]"
            >
            ...
            <div className="flex flex-wrap justify-center gap-3 text-sm">
              {group.items.map((tech, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-white text-black px-4 py-2 rounded-full shadow-sm
                    hover:bg-gray-200 hover:scale-105 transition duration-300 cursor-default"
                >
                  {tech}
                </motion.div>
              ))}
      ...
      {/* ── Latest Posts / BlogPreview (white) ───────────── */}
